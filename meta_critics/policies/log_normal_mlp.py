...
from torch.distributions import Independent, Normal, LogNormal
...
class LogNormalMLPPolicy(Policy, nn.Module):
    ...
    def __init__(self,
        ...
        super(LogNormalMLPPolicy, self).__init__(input_size=input_size,
    ...
    @staticmethod
    def weight_init_kaiming(self, module):
        """
        :return:
        """
    ...
    def forward(self, x, W=None):
        ...
        try:
            Independent(LogNormal(loc=mu, scale=scale), 1)
        ...
        return Independent(LogNormal(loc=mu, scale=scale), 1)
